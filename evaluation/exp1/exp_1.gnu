...
set label "Normal conditions" at 40,0.3 
set label "Hazy conditions" at 105,0.3
plot [0:159] [0:0.95] 'cnn.tmp'using ($0/30):3 with lines title 'Standalone lidar' lw 2,\
...
'fog1.lin' using 1:2 with lines lt 2 lw 2 lc 0 notitle
